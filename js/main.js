...
alert(string_2 = "'" + string.slice(4, 9) + "'");//с 5-го символа с 4-ым индексом выводим 5 символов(4 буквы! + пробел)

//6. Получить строку с 5-го по 9-й символы
alert(string_2 = "'" + string.slice(4, 9) + "'");//с 5-го символа с 4-ым индексом по 9-ый символ с 8-ым индексом  
...
let randomNumber;
randomNumber = ((Math.round(Math.random()*100)/100));
randomNumber = Math.random() * 100;//формула Math.random() * (max - min) + min;
